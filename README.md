...
Open Image_class.ipynb in Google Colab
Download the dataset from the Kaggle link above and place it in the expected directory structure
Run all cells in order (GPU runtime recommended for faster training)
